...
<template>
    <div class="contact">
        ...
        <form class="contact__form" action="https://formsubmit.co/c16eec4c55cc767ae24ded1b38224f83" method="post">
            ...
            <button class="contact__form__button" type="submit">Enviar</button>
        </form>
